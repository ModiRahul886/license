...
class Common_model extends CI_Model {
	...
	// Name :- pankajkesharvani4197@gmail.com   Date :- 23/03/22
	// Desc :- get hotel details
	function get_hotel_details($iOwnerId,$eUserType) {
		if($eUserType != ''){
            $this->db->select('iOwnerId,vFirstName,vLastName,vEmail,iMobileNo,dCreatedDate,eDesignation,eStatus');
