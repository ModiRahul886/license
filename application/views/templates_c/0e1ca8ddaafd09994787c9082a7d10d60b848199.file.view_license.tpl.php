<?php /* Smarty version Smarty-3.1.11, created on 2026-01-26 23:10:37
         compiled from "E:\xampp\htdocs\license\application\views\templates\admin\license\view_license.tpl" */ ?>
<?php /*%%SmartyHeaderCode:190992111697791fd4c9879-13791782%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0e1ca8ddaafd09994787c9082a7d10d60b848199' => 
    array (
      0 => 'E:\\xampp\\htdocs\\license\\application\\views\\templates\\admin\\license\\view_license.tpl',
      1 => 1682010548,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '190992111697791fd4c9879-13791782',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_697791fd54cb00_43500185',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_697791fd54cb00_43500185')) {function content_697791fd54cb00_43500185($_smarty_tpl) {?>
<form name="frmlist" id="frmlist" action="<?php echo $_smarty_tpl->tpl_vars['data']->value['admin_url'];?>
license/action_update" method="post">
...
license/create');"  class="btn btn-primary btnuser newadbtn"> Add New</button>
                            <?php }?>
...
license/create');"  class="btn btn-primary btnuser newadbtn"> Add New</button>
						...
						<table id="barlist" class="table table-bordered table-striped">
							...
							<tbody>
								<?php if (count($_smarty_tpl->tpl_vars['data']->value['license_detail'])>0){?>
									<?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']['i'])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']['i']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['name'] = 'i';
$_smarty_tpl->tpl_vars['smarty']->value['section']['i']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['data']->value['license_detail']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
										<tr>
											<td align="center">
												<input type="checkbox" name="iId[]" id="iId" class="tableflat" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['license_detail'][$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['ilicenseId'];?>
"/>
											</td>
											<td><?php echo $_smarty_tpl->tpl_vars['data']->value['license_detail'][$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['licensename'];?>
</td>
											<td><?php echo $_smarty_tpl->tpl_vars['data']->value['license_detail'][$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['license_key'];?>
</td>
											<td><?php echo $_smarty_tpl->tpl_vars['data']->value['license_detail'][$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['license_active_date'];?>
</td>
											<td><?php echo $_smarty_tpl->tpl_vars['data']->value['license_detail'][$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['license_expire_date'];?>
</td>
											<td><?php echo $_smarty_tpl->tpl_vars['data']->value['license_detail'][$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['eStatus'];?>
</td>
											<?php if ($_smarty_tpl->tpl_vars['data']->value['happyhour_admin_info']['eRole']=='Subadmin'){?>
                                    			<?php if (in_array($_smarty_tpl->tpl_vars['data']->value['checkmoduleid'],$_smarty_tpl->tpl_vars['data']->value['adminpermidetail']['tUpdate'])){?>
												<td align="center"><a href="<?php echo $_smarty_tpl->tpl_vars['data']->value['admin_url'];?>
license/update/<?php echo $_smarty_tpl->tpl_vars['data']->value['license_detail'][$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['ilicenseId'];?>
