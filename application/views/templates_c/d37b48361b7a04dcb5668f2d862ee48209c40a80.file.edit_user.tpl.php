<?php /* Smarty version Smarty-3.1.11, created on 2026-01-26 23:18:44
         compiled from "E:\xampp\htdocs\license\application\views\templates\admin\user\edit_user.tpl" */ ?>
<?php /*%%SmartyHeaderCode:360868693697793e49f5831-01775654%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd37b48361b7a04dcb5668f2d862ee48209c40a80' => 
    array (
      0 => 'E:\\xampp\\htdocs\\license\\application\\views\\templates\\admin\\user\\edit_user.tpl',
      1 => 1682010818,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '360868693697793e49f5831-01775654',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_697793e4a98470_34592614',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_697793e4a98470_34592614')) {function content_697793e4a98470_34592614($_smarty_tpl) {?><style type="text/css">
	.numbermobi{
										...
										<div class="form-group">
			                                ...
			                                <div class="fileupload fileupload-new" data-provides="fileupload">
			                                    ...
			                                    <a href="#myModal" class="btn bottom-buffer" data-toggle="modal">
			                                    	<img src="<?php echo $_smarty_tpl->tpl_vars['data']->value['user_detail']['vProfilePicture'];?>
" alt="" class="thumbnail"/>
			                                    </a>
			                                    </div>
			                                    <div>
			                                    <?php if ($_smarty_tpl->tpl_vars['data']->value['user_detail']['imagetype']=='withouturl'){?>
...
/<?php echo $_smarty_tpl->tpl_vars['data']->value['user_detail']['image_name'];?>
/vProfilePicture" class="btn btn-danger" data-dismiss="fileupload"><i class="fa fa-trash"></i> Remove</a>
			                                    <?php }else{ ?>
			                                    	<a href="<?php echo $_smarty_tpl->tpl_vars['data']->value['base_url'];?>
admin/user/deletewithurlimage/<?php echo $_smarty_tpl->tpl_vars['iUserId']->value;?>
/vProfilePicture" class="btn btn-danger" data-dismiss="fileupload"><i class="fa fa-trash"></i> Remove</a>
			                                   	<?php }?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo $_smarty_tpl->tpl_vars['data']->value['user_detail']['vFirstName'];?>
 <?php echo $_smarty_tpl->tpl_vars['data']->value['user_detail']['vLastName'];?>
 </h4>
            </div>
            <div class="modal-body row">
                ...
                <?php if ($_smarty_tpl->tpl_vars['data']->value['user_detail']['imagetype']=='withouturl'){?>
                    <img src="<?php echo $_smarty_tpl->tpl_vars['data']->value['user_detail']['vProfilePicture'];?>
" alt="" controls style="align:center;height:400px;width:550px;"/>
                <?php }else{ ?> 
                	<img src="<?php echo $_smarty_tpl->tpl_vars['data']->value['user_detail']['vProfilePicture'];?>
" style="align:center;height:400px;width:550px;">
                <?php }?>
                </div>
            </div>
        </div>
