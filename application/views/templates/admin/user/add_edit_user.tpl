...
<div class="rightside">
    <div class="page-head breadpad">
        <ol class="breadcrumb">
            ...
            <li class="active">{if $data.action eq 'update'}Update{else}Add{/if} User</li>      
        </ol>
    </div>
								...
								<div class="form-group">
	                                ...
	                                <div class="fileupload fileupload-new" data-provides="fileupload">
	                                    ...
	                                    <a href="#myModal" class="btn bottom-buffer" data-toggle="modal">
	                                        <img src="{$data.base_url}uploads/user/{$iUserId}/{$data.user_detail.vProfilePicture}" alt="" class="thumbnail"/>
	                                    </a>
	                                    </div>
	                                    <div>
	                                        <a href="{$data.base_url}admin/user/deleteimage/{$iUserId}/{$data.user_detail.vProfilePicture}/vProfilePicture" class="btn btn-danger" data-dismiss="fileupload"><i class="fa fa-trash"></i> Remove</a>
