				...
				<div class="box">
                    ...
                    <div class="box-body">
                        ...
                        {if $data.happyhour_admin_info.eRole eq 'Subadmin'}
                            {if $data.checkmoduleid|in_array:$data.adminpermidetail.tExportUsers}
	                    ...
	                    <table id="userlisting" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <td align="center">
                                    ...
                                    <td>{$data.userlist[i].eRole}</td>
                                    <td>{$data.userlist[i].eStatus}</td>
                                    {if $data.happyhour_admin_info.eRole eq 'Subadmin'}
                                        {if $data.checkmoduleid|in_array:$data.adminpermidetail.tUpdate}
                                            <td align="center"><a href="{$data.admin_url}user/update/{$data.userlist[i].iUserId}" style="cursor:pointer;"><i class="fa fa-edit edtcolr"></i></a></td>
                                        {/if}
                                    {else}
                                        <td align="center"><a href="{$data.admin_url}user/update/{$data.userlist[i].iUserId}" style="cursor:pointer;"><i class="fa fa-edit edtcolr"></i></a></td>
                                    {/if}
...
<script type="text/javascript">
    ...
    function callExportUsers(){
        var newexporturl = "{/literal}{$data.admin_url}user/exportToExcel{literal}";
