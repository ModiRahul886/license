...
<form name="frmlist" id="frmlist" action="{$data.admin_url}state/action_update" method="post">
            ...
            <div class="block-content collapse in">
                ...
                {/if}
                    ...
                    <div class="pull-right">
                        ...
                        <button type="button" id="btn-add" onclick="addme('{$data.admin_url}state/create');"  class="btn bottom-buffer"> Add New</button>
...
function Export()
{
    window.location.href=base_url+"state/exportcsv";
}
