...
<head>
    ...
    <link rel="stylesheet" href="{$data.admin_css_path}bootstrap-tagsinput/bootstrap-tagsinput.css?v=1" />
    ...
    <link rel="stylesheet" href="{$data.admin_css_path}style.css?v={time()}" />
