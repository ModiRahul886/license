                    ...
                    <div class="box-body">
                        ...
                        <table id="adminlisting" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                <td align="center">
                                    {if $data.adminlist[i].iAdminId neq 1}
                                    ...
                                    <td align="center">
                                        {if $data.adminlist[i].iAdminId eq 1}
                                        <a href="{$data.admin_url}admin_management/update/{$data.adminlist[i].iAdminId}" style="cursor:pointer;"><i class="fa fa-edit edtcolr"></i></a>
                                        {/if}
                                </td>
                                </tr>
                                {/section} 
