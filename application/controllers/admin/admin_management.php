...
class Admin_management extends Admin_Controller {
    ...
    function create() {
        ...
        if ($this->input->post()) {
            ...
            $admin_detail['iMobileNo'] = $this->input->post('iMobileNo');
    ...
    function update() {
        ...
        $this->data['admin_detail']['iMobileNo'] = $this->data['admin_detail']['iMobileNo'];
        /* All Module */
    ...
    function get_admin_listing() {
        $this->data['menuAction'] = 'Administrator';
        $id = $this->data['userdata']['license_admin_info']['iAdminId'];
