...
class Authentication extends Admin_Controller {
    ...
    public function index() {
        ...
        if (isset($this->session->userdata['license_admin_info'])) {
            ...
            if ($auth_exists) {
                ...
                $this->session->set_userdata('license_admin_info', $auth_exists);
    ...
    function logout() {
        ...
        $logindata['iLoginLogId'] = $this->data['license_admin_info']['iLoginLogId'];
        $logindata['dLogoutDate'] = $dLogoutDate;
        $this->session->unset_userdata("license_admin_info");
        redirect($this->data['admin_url'] . 'authentication');
        exit();
    }
}
